...
API_TOKEN = '8233954383:AAG9eY8I1rKcF-4IiltEvowkcTf13S6RCTo'
...
# Danh sách admin
admins = [5627516174,7205961265]  # Danh sách ID admin
...
def initialize_user(user_id):
    ...
    if user_id_str not in user_data:
        user_data[user_id_str] = {'balance': 0, 'referrals': []}
        save_data(user_data_file, user_data)
...
def update_user_balance(user_id, amount):
    ...
    if user_id_str in user_data:
        ...
        user_data[user_id_str] = {'balance': amount, 'referrals': []}
    save_data(user_data_file, user_data)
